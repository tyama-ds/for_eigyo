...
- **束ねて分光** — 複数フィードを 1 グリッドに集約。カテゴリ（総合 / テクノロジー /
  ...
  Ars Technica / HBR / MONOist / EE Times / arXiv、および **鉄鋼・素材系**：Nature
...
Review、MONOist、EE Times Japan、arXiv cs.AI）を初期登録。さらに**鉄鋼・素材系**として
次を追加した:
...
UI の「情報源」から自由に 追加 / 無効化 / 削除でき、URL もその場で貼り替えられる。
